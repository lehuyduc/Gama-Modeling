...
experiment E3_12 {
	...
	init {
		create simulation with:[humanNumber::humanNumber, initialInfected::initialInfected, contagionInBuilding::contagionInBuilding, policyTriggerMode::policyTriggerMode, 
								nbTestPerDay::nbTestPerDay, timeToApply::timeToApply, policyWearMask::1];
		
		create simulation with:[humanNumber::humanNumber, initialInfected::initialInfected, contagionInBuilding::contagionInBuilding, policyTriggerMode::policyTriggerMode, 
								nbTestPerDay::nbTestPerDay, timeToApply::timeToApply, policyWearMask::1, policyContainByAge::1];
